        ...
        <>
            <form onSubmit={handleSubmit(SignUpFunc)}>
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 container m-auto">
                    <h1 className="mb-6 text-3xl text-center font-bold">Sign Up As Blood Donor</h1>
                    <hr className="mb-6" />
                    {
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="full_name" type="text" placeholder="John Doe" name="Full_Name" ref={register({ required: "Please enter your first name.", minLength: 6 })} />
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="email" type="text" placeholder="john.doe@gmail.com" name="Email" ref={register({
                                required: true,
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <div className="relative">
                                <select className="block w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-16 rounded" id="gender" name="Gender" ref={register({ required: true })} >
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="phone" type="tel" placeholder="91XXXXXXXXXX" name="Phone" ref={register({
                                required: true,
                                pattern: /(91)\d{10}/,
                            })} />
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3">
                            ...
                            <div className="relative">
                                <select className="block w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-16 rounded" id="blood_group" name="Blood_Group" ref={register({ required: true })} >
                                    <option value="none">None</option>
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div className="relative">
                                <select className="block w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-16 rounded" id="donated" name="Donated" ref={register({ required: true })} onChange={(event) => setDonated(event.target.value)}>
                                    <option value="none">None</option>
                        ...
                        </div>
                        {
                            Donated == "yes" ? (
                                <div className="md:w-1/2 px-3">
                                    ...
                                    <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="donated_date" type="date" name="Last_Donated" ref={register({ required: true })} />
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div className="relative">
                                <select className="block w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-16 rounded" id="district" name="District" ref={register({ required: true })} >
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div className="relative">
                                <select className="block w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-16 rounded" id="upazila" name="Upazila" ref={register({ required: true })} >
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-full px-3">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="location" type="text" placeholder="Amla" name="Location" ref={register({ required: true })} />
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="password" type="password" placeholder="******************" name="Password" ref={register({ required: true, validate: true, minLength: 6 })} />
                        ...
                        <div className="md:w-1/2 px-3">
                            <label className="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" htmlFor="password_conf">
                                Confirm Password
</label>
                            <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="password_conf" type="password" placeholder="******************" name="Password_conf" ref={register({ required: true, validate: true, minLength: 6 })} />
                            {errors.Password?.type === "required" && (
                                <p className="text-red-400 text-xs font-bold italic">This Confirm Password Field Is Required.</p>
                            )}
                            {errors.Password?.type === "minLength" && (
                                <p className="text-red-400 text-xs font-bold italic">This Confirm Passsword should be at least 6 characters long.</p>
                            )}
                            {
                                watch("Password") != watch("Password_conf") ? <p className="text-red-400 text-xs font-bold italic">This Confirm Passsword didn't matched with Password.</p> : ""
                            }
                        </div>
                    </div>
                    <input type="submit" className="py-4 bg-green-400 rounded text-white text-2xl" value="Sign Up" />
                </div>
            </form>
        </>
    )
